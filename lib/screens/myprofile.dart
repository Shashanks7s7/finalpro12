...
void removeitems( String id )async{
 
       
       
try{await FirebaseFirestore.instance.collection('registration').doc(id).delete();
    setState(() {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Container(
                    ...
                    margin: EdgeInsets.symmetric(horizontal: size.width / 36),
                    decoration: BoxDecoration(
                    ...
                    child: Stack(
                      ...
                      children: [
                        Positioned(
                          left: -size.width / 18,
                          top: childlist.length==1?-size.height / 40.2:-size.height/160,
                          child: Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: size.height / 120.8),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: FittedBox(
                                              child: Text(childlist[index]['address'].toString().trim(),style: TextStyle(fontSize: 15),)))
                                    ],
                                  ),
                                  SizedBox(
                                    width: size.width / 40,
                                  ...
                                  Row(
                                    children: [
                                     ...
                                     if(childlist[index]['male'])
                                              Text("Male"),
                                              if(childlist[index]['female'])
                                              Text("Female"),
                                    ],
                                  )
                                ],
 ...
 showDialog(context: context, builder: (BuildContext context)=>
   AlertDialog(
     ...
     actions: [
       ...
       TextButton(onPressed: ()=>removeitems(childlist[index]['id']),child: Text('Ok'),)]));},
